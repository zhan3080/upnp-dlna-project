...
import com.xxx.test.upnp.http.HTTPResponse;
import com.xxx.test.upnp.http.HTTPServerList;
import com.xxx.test.upnp.http.HTTPStatus;
import com.xxx.test.upnp.net.HostInterface;
import com.xxx.test.upnp.soap.SOAPResponse;
import com.xxx.test.upnp.upnp.control.ActionListener;
import com.xxx.test.upnp.upnp.control.ActionRequest;
import com.xxx.test.upnp.upnp.control.ActionResponse;
import com.xxx.test.upnp.upnp.control.ControlRequest;
import com.xxx.test.upnp.upnp.control.ControlResponse;
import com.xxx.test.upnp.upnp.control.QueryListener;
import com.xxx.test.upnp.upnp.control.QueryRequest;
import com.xxx.test.upnp.upnp.device.Advertiser;
import com.xxx.test.upnp.upnp.device.Description;
import com.xxx.test.upnp.upnp.device.InvalidDescriptionException;
import com.xxx.test.upnp.upnp.device.NTS;
import com.xxx.test.upnp.upnp.device.ST;
import com.xxx.test.upnp.upnp.device.SearchListener;
import com.xxx.test.upnp.upnp.device.USN;
import com.xxx.test.upnp.upnp.device.PresentationListener;
import com.xxx.test.upnp.upnp.event.Subscriber;
import com.xxx.test.upnp.upnp.event.Subscription;
import com.xxx.test.upnp.upnp.event.SubscriptionRequest;
import com.xxx.test.upnp.upnp.event.SubscriptionResponse;
import com.xxx.test.upnp.upnp.ssdp.SSDPNotifyRequest;
import com.xxx.test.upnp.upnp.ssdp.SSDPNotifySocket;
import com.xxx.test.upnp.upnp.ssdp.SSDPPacket;
import com.xxx.test.upnp.upnp.ssdp.SSDPSearchResponse;
import com.xxx.test.upnp.upnp.ssdp.SSDPSearchResponseSocket;
import com.xxx.test.upnp.upnp.ssdp.SSDPSearchSocketList;
import com.xxx.test.upnp.upnp.xml.DeviceData;
import com.xxx.test.upnp.util.Debug;
import com.xxx.test.upnp.util.FileUtil;
import com.xxx.test.upnp.util.Mutex;
import com.xxx.test.upnp.util.TimerUtil;
import com.xxx.test.upnp.xml.Node;
import com.xxx.test.upnp.xml.Parser;
import com.xxx.test.upnp.xml.ParserException;
import com.xxx.test.upnp.xml.XML;

public class Device implements com.xxx.test.upnp.http.HTTPRequestListener,
		SearchListener {
	// //////////////////////////////////////////////
	// Constants
	// //////////////////////////////////////////////
