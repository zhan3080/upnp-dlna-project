...
*	05/11/09
*		- Changed loadDefaultXMLParser() to load com.xxx.test.upnp.xml.parser.XmlPullParser at first.
*	
******************************************************************/
...
import com.xxx.test.upnp.soap.SOAP;
...
public class UPnP
{
	...
	private static Parser loadDefaultXMLParser() {
		...
		String[] parserClass = new String[]{
				...
				"com.xxx.test.upnp.xml.parser.XmlPullParser",
				"com.xxx.test.upnp.xml.parser.JaxpParser",
				"com.xxx.test.upnp.xml.parser.kXML2Parser"
		};
